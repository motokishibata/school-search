...
全国に展開されている<span class="st-mymarker-s">校舎（※）に行けば講師に直接質問することも</span>できますし、キャリアの相談なども可能です。  
...
ヒューマンアカデミーのプログラミング講座は多数の講座があるうえ、<span class="st-mymarker-s">年齢に関係なく</span>就職サポートを受けることができます！
